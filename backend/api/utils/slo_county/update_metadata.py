...
def update_metadata(hearingsScraped: int, scrapedProjects: List[Project]) -> None:
    newProjects = 0
    newSCHProjects = 0
    ...
    if client:
        ...
        # date uses iso format for conversion between python datetime to TS Date objects
